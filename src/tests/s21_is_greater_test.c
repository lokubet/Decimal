...
START_TEST(is_greater_test0) {
  s21_decimal d_val = {.bits = {0, 0, 0, 0}}, d = {.bits = {0, 0, 0, 0}};
  ck_assert_int_eq(s21_is_greater(d_val, d), 0);
}
END_TEST
...
START_TEST(is_greater_test6) {
  ...
  ck_assert_int_eq(s21_is_greater(d_val, d), 1);
}
END_TEST
...
Suite *s21_is_greater_suite(void) {
  ...
  TCase *tc_core = tcase_create("Is_greater");
  tcase_add_test(tc_core, is_greater_test0);
  tcase_add_test(tc_core, is_greater_test1);
  tcase_add_test(tc_core, is_greater_test2);
  tcase_add_test(tc_core, is_greater_test3);
  tcase_add_test(tc_core, is_greater_test4);
  tcase_add_test(tc_core, is_greater_test5);
  tcase_add_test(tc_core, is_greater_test6);
  tcase_add_test(tc_core, is_greater_test7);
  tcase_add_test(tc_core, is_greater_test8);
  tcase_add_test(tc_core, is_greater_test9);
  tcase_add_test(tc_core, is_greater_test10);
  tcase_add_test(tc_core, is_greater_test11);
  tcase_add_test(tc_core, is_greater_test12);
  tcase_add_test(tc_core, is_greater_test13);
