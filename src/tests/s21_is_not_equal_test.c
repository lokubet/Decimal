...
START_TEST(is_not_equal_test0) {
  s21_decimal d_val = {.bits = {0, 0, 0, 0}}, d = {.bits = {0, 0, 0, 0}};
  ck_assert_int_eq(s21_is_not_equal(d_val, d), 0);
}
END_TEST
...
START_TEST(is_not_equal_test5) {
  ...
  ck_assert_int_eq(s21_is_not_equal(d_val, d), 1);
}
END_TEST
...
Suite *s21_is_not_equal_suite(void) {
  ...
  TCase *tc_core = tcase_create("Is_not_equal");
  tcase_add_test(tc_core, is_not_equal_test0);
  tcase_add_test(tc_core, is_not_equal_test1);
  tcase_add_test(tc_core, is_not_equal_test2);
  tcase_add_test(tc_core, is_not_equal_test3);
  tcase_add_test(tc_core, is_not_equal_test4);
  tcase_add_test(tc_core, is_not_equal_test5);
  tcase_add_test(tc_core, is_not_equal_test6);
  tcase_add_test(tc_core, is_not_equal_test7);
  tcase_add_test(tc_core, is_not_equal_test8);
  tcase_add_test(tc_core, is_not_equal_test9);
  tcase_add_test(tc_core, is_not_equal_test10);
  tcase_add_test(tc_core, is_not_equal_test11);
  tcase_add_test(tc_core, is_not_equal_test12);
